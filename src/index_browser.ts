// Browser-specific entry point with global assignments
...
// Extend global interface for browser compatibility
declare global {
  interface Window {
...
// Assign to global objects for browser script tag usage
